...
from . import views
from .views import autocompletar_direcciones, autocompletar_usuarios, editar_ticket_view, eliminar_ticket_view, gestionar_tickets_view, gestionar_usuario_view, editar_usuario_view, eliminar_usuario_view, obtener_tickets_global
...
urlpatterns = [
    ...
    path('obtener_tickets_global/', views.obtener_tickets_global, name='obtener_tickets_global'),
